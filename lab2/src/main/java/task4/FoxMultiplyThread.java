 ...
 * @author Devid
 */
public class FoxMultiplyThread extends Thread{
    ...
    FoxMultiplyThread(int[][] aMatrix, int[][] bMatrix, int[][] cMatrix, int a_i, int a_j, int b_i, int b_j, int c_i, int c_j, int size, ExecutorService exec) {
    ...
    public void run() {
        ...
        if (size <= MINIMUM_THRESHOLD) {
            ...
            FoxMultiplyThread[] tasks = {
                    new FoxMultiplyThread(aMatrix, bMatrix, cMatrix, a_i, a_j, b_i, b_j, c_i, c_j, h, this.exec),
                    new FoxMultiplyThread(aMatrix, bMatrix, cMatrix, a_i, a_j, b_i, b_j + h, c_i, c_j + h, h, this.exec),
                    new FoxMultiplyThread(aMatrix, bMatrix, cMatrix, a_i + h, a_j + h, b_i + h, b_j, c_i + h, c_j, h, this.exec),
                    new FoxMultiplyThread(aMatrix, bMatrix, cMatrix, a_i + h, a_j + h, b_i + h, b_j + h, c_i + h, c_j + h, h, this.exec),

                    new FoxMultiplyThread(aMatrix, bMatrix, cMatrix, a_i, a_j + h, b_i + h, b_j, c_i, c_j, h, this.exec),
                    new FoxMultiplyThread(aMatrix, bMatrix, cMatrix, a_i, a_j + h, b_i + h, b_j + h, c_i, c_j + h, h, this.exec),
                    new FoxMultiplyThread(aMatrix, bMatrix, cMatrix, a_i + h, a_j, b_i, b_j, c_i + h, c_j, h, this.exec),
                    new FoxMultiplyThread(aMatrix, bMatrix, cMatrix, a_i + h, a_j, b_i, b_j + h, c_i + h, c_j + h, h, this.exec)
            };
